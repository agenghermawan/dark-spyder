...
import DynamicDataTable from '../../../components/ui/dynamic-datatable';
      ...
      .flatMap((item) => {
        ...
        return dataItems.map((dataItem) => {
          ...
          return {
            ...
            company,
            summary:
              dataItem?.Summary || source?.Info || "No summary available",
  ...
  return (
    <div className="relative">
        ...
        <section className="absolute inset-0 flex items-center justify-center px-4 sm:px-6 lg:px-8 text-white z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-gray-300">
              Search through billions of compromised credentials <br /> from
      ...
      {(breachData.length > 0 || showEmptyAlert) && (
        <section
          className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0f0f15]"
          ref={resultsRef}
        >
                ...
                <tbody>
                  {breachData.length > 0 ? (
                    breachData.map((entry, index) => (
                      ...
                      >
                        {/* Ganti kolom Profile Information jadi dinamis */}
                        <td className="py-4 px-6">
                          {/* Gunakan data mentah dari rawData jika ada, fallback ke entry */}
                          <DynamicDataTable data={entry.rawData || entry} />
                        </td>
                        {/* Kolom lain tetap pakai field transform seperti sekarang */}
                        <td className="py-4 px-6">
                          <div className="space-y-2">
                            <div className="flex items-center">
                              <span
                                className={`font-medium ${
                                  entry.isTeaser ? "text-gray-400" : ""
                                }`}
                              >
                                {entry.position}
                              </span>
                          ...
                          <div className="space-y-2">
                            <span
                              className={`inline-flex items-center px-3 py-1 rounded-full ${
                                entry.isTeaser
                                  ? "bg-gradient-to-r from-gray-700 to-gray-800 text-gray-500"
                          ...
                          {entry.isTeaser ? (
                            ...
                            <div className="flex flex-col gap-2 sm:flex-row sm:justify-center">
                              <span
                                className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                                  entry.severity === "Critical"
                                    ? "bg-gradient-to-r from-red-600 to-red-800 text-red-100"
                                    : entry.severity === "High"
                                    ? "bg-gradient-to-r from-orange-600 to-orange-800 text-orange-100"
                                    : entry.severity === "Low"
                                    ? "bg-gradient-to-r from-green-600 to-green-800 text-green-100"
                              ...
                              <button
                                onClick={() =>
                                  router.push(
                                    `/profile-details/${encodeURIComponent(
                                      entry.email
                                    )}`
                                  )
                                }
                      ...
                      <td colSpan="4" className="py-12 px-6 text-center">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <p className="text-gray-500 max-w-md">
                            Try different search terms or check if you have the
                            correct permissions to view this data.
                          </p>
                        </div>
                      </td>
                    </tr>
              ...
              <div className="mt-6 flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-sm ${
                      pagination.page * pagination.size >= pagination.total
                        ? "bg-[#0aafff]/50 cursor-not-allowed"
                        : "bg-[#0aafff] hover:bg-[#0088cc]"
                    } rounded-lg transition-colors`}
                  >
                    Next
