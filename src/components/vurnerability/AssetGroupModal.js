                                    ...
                                    <div key={item.id} className="flex flex-col md:flex-row gap-4 items-start bg-[#19191d] rounded-xl shadow p-4 border border-gray-800">
                                        ...
                                        <div className="flex-1 flex flex-col gap-2">
                                            ...
                                            <div className="flex flex-wrap gap-2 mt-3 items-center">
                                                ...
                                                {/* Trash icon (dummy) */}
                                                <button className="ml-2 text-gray-500 hover:text-red-400 transition" title="Delete">
                                                    <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                                        <path d="M3 6h18M9 6V4a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2m3 0v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6h16z"/>
                                                    </svg>
                                                </button>
                                            </div>
                                        </div>
