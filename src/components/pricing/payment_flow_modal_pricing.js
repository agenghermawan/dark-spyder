...
// Stepper indicator (no neon, just clean)
        ...
        <div className="flex items-center justify-center mb-8">
            {steps.map((s, i) => (
                <div key={s} className="flex items-center">
                    ...
                    {i < steps.length - 1 && (
                        <div className={`w-10 h-1 mx-2 rounded ${
                            step > i
                                ? "bg-gray-400"
                                : "bg-gray-700"
                        }`} />
...
export default function PaymentFlowModalPricing({
    ...
    // Step calculation
    let step = 0;
    if (showRegisterForm) step = 3;
    else if (paymentData && paymentStatus && paymentStatus.Status === 100) step = 2;
    else if (paymentData) step = 1;

    return (
        <div className="fixed inset-0 z-50 flex items-start justify-center px-2 bg-black/70 backdrop-blur-[3px] overflow-y-auto py-8">
            <div className="relative w-full max-w-[45%] bg-gradient-to-br from-[#18181c] via-[#232339] to-[#18181c] rounded-3xl shadow-lg border border-gray-700 p-0 sm:p-8 animate-fade-in-up overflow-hidden max-h-[95vh] flex flex-col">
                {/* Loader overlay on any loading */}
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar px-1 sm:px-0 pb-4">
                        ...
                        <>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <select
                                        className="w-full py-3 px-5 rounded bg-gray-800 text-white text-lg border border-gray-700 focus:ring-2 focus:ring-gray-500"
                            ...
                            >
                                Continue & Show Payment Instructions
                            </button>
                            ...
                            <div className="mt-8 text-center">
                                {notPaidError && (
                                    <div className="text-yellow-400 mt-4">
                                        Payment not received yet. Please try again in a few moments.<br /><br />
                                    </div>
                                )}
                                <button
                    ...
                    {step === 3 && (
                        <div className="mt-6 border-t border-gray-700 pt-5 bg-gray-900 rounded-2xl shadow">
